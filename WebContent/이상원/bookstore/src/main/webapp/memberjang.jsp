...
<table align="center">	
	<tr>
		<th colspan="4" width="300" height="150" align="center" style="background-color: aqua;">총 115,000원 입니다.</th>
	</tr>
	
	<tr>
		<td></td>
		<td><a href="#" class="btn-3d cyan" onclick="alert('주문이 완료 되었습니다.')">비회원 구매</a></td>
		<td><a href="#" class="btn-3d cyan" onclick="alert('주문이 완료 되었습니다.')">회원 구매</a></td>
