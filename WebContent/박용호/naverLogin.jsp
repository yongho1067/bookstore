...
<head>
    ...
    <title>NaverLoginSDK</title></head>
<body> callback 처리중... <!-- (1) LoginWithNaverId Javscript SDK -->
    <script type="text/javascript" src="https://static.nid.naver.com/js/naveridlogin_js_sdk_2.0.2.js" charset="utf-8"></script> <!-- (2) LoginWithNaverId Javscript 설정 정보 및 초기화 -->
    <script> var naverLogin = new naver.LoginWithNaverId({
        clientId: "RDdgbivY7FUS7o1r_0v0",
        callbackUrl: "http://localhost:8080/bookstore/naverLogin.jsp",
        isPopup: false,
