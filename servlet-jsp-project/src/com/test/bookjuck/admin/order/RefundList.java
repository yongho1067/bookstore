...
@WebServlet("/admin/order/refundlist.do")
		...
		if (type.equals("1")) {
			...
			if(n == 1) {
				...
				pagebar += String.format("<li>"
							+ "            <a href=\"/bookjuck/admin/order/refundlist.do?type=%d&page=%d&startDate=%s&endDate=%s&ordernumsearch=%s&idsearch=%s&booksearch=%s\" aria-label=\"Previous\">"
							+ "                <span aria-hidden=\"true\">&laquo;</span>"
							+ "            </a>"
			...
			while (!(loop > blockSize || n > totalPage)) {
				...
				pagebar += String.format("<a href=\"/bookjuck/admin/order/refundlist.do?type=%d&page=%d&startDate=%s&endDate=%s&ordernumsearch=%s&idsearch=%s&booksearch=%s\">%d</a></li> ", 1, n, startDate, endDate, ordernumsearch, idsearch, booksearch, n);
			...
			if (n > totalPage) {
				...
				pagebar += String.format("<li>"
						+ "            <a href=\"/bookjuck/admin/order/refundlist.do?type=%d&page=%d&startDate=%s&endDate=%s&ordernumsearch=%s&idsearch=%s&booksearch=%s\" aria-label=\"Next\">"
						+ "                <span aria-hidden=\"true\">&raquo;</span>"
						+ "            </a>"
			...
			while (!(loop > blockSize || n > totalPage)) {
				...
				pagebar += String.format("<a href=\"/bookjuck/admin/order/refundlist.do?type=%d&page=%d&startDate=%s&endDate=%s&ordernumsearch=%s&idsearch=%s&booksearch=%s\">%d</a></li> ", 2, n, startDate, endDate, ordernumsearch, idsearch, booksearch, n);
			...
			while (!(loop > blockSize || n > totalPage)) {
				...
				pagebar += String.format("<a href=\"/bookjuck/admin/order/refundlist.do?type=%d&page=%d&startDate=%s&endDate=%s&ordernumsearch=%s&idsearch=%s&booksearch=%s\">%d</a></li> ", 3, n, startDate, endDate, ordernumsearch, idsearch, booksearch, n);
