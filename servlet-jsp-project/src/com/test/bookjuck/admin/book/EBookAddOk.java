...
@WebServlet("/admin/book/ebookaddok.do")
public class EBookAddOk extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			if (result == 1) {
				...
				writer.print("<script>");
				writer.print("alert('E-Book 추가 성공!\\nE-Book 리스트로 이동합니다.');");
				...
				writer.print("<html><head><meta charset='UTF-8' /></head><body>");
				writer.print("<script>");
				writer.print("alert('E-Book 추가 실패..\\n이전 화면으로 이동합니다.');");
