	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if(n == 1) {
			...
			pagebar += String.format("<li>"
						+ "            <a href=\"/bookjuck/member/fleamarket/thumbnail.do?page=%d\" aria-label=\"Previous\">"
						+ "                <span aria-hidden=\"true\">&laquo;</span>"
						+ "            </a>"
						+ "         </li>", n - 1);			
		}
		...
		while (!(loop > blockSize || n > totalPage)) {
			...
			pagebar += String.format("<a href=\"/bookjuck/member/fleamarket/thumbnail.do?page=%d\">%d</a></li> ", n, n);
		...
		if (n > totalPage) {
			...
			pagebar += String.format("<li>"
					+ "            <a href=\"/bookjuck/member/fleamarket/thumbnail.do?page=%d\" aria-label=\"Next\">"
					+ "                <span aria-hidden=\"true\">&raquo;</span>"
					+ "            </a>"
					+ "          </li> ", n);
		}
