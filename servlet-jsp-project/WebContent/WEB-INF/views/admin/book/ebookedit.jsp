...
<title>북적북적_Admin::EBook수정</title>
...
<body>
	...
	<section class="contentsection">
		...
		<form method="POST" action="/bookjuck/admin/book/ebookeditok.do" enctype="multipart/form-data" id="formEdit">
			<div class="form-group">
		    	<label for="title">도서명</label>
		    	<input type="text" class="form-control" id="title" name="title" placeholder="도서명을 입력해주세요." maxlength=50 required value="${dto.title}">
		  	</div>
		  	
			<div class="form-group">
		    	<label for="publisher">출판사</label>
		    	<input type="text" class="form-control" id="publisher" name="publisher" placeholder="출판사를 입력해주세요." maxlength=20 required value="${dto.publisher}">
		  	</div>
		  	...
		  	<div class="form-group">
		    	<label>카테고리</label>
					<div class="form-inline">
						...
						<input type="hidden" id="seqSCategory" name="seqSCategory" value="${dto.seqSCategory}">
			...
			<div class="form-group">
		    	...
		    	<input type="hidden" id="seqAuthor" name="seqAuthor" value="${dto.seqAuthor}">
		  	</div>
			...
			<div class="form-group">
		    	...
		    	<input type="date" class="form-control" id="pubdate" name="pubDate" required value="${dto.pubDate}">
		  	</div>
		  	
			<div class="form-group">
		    	<label for="isbn">ISBN</label>
		    	<input type="text" class="form-control" id="isbn" name="isbn" placeholder="ISBN을 입력해주세요." maxlength=13 required value="${dto.isbn}">
		  	</div>
		  	
			<div class="form-group">
		    	<label for="price">정가 (단위 : 원)</label>
		    	<input type="text" class="form-control" id="price" name="price" value="0" required value="${dto.price}">
		  	</div>
		  	
			<div class="form-group">
		    	<label for="copy">한줄카피</label>
		    	<input type="text" class="form-control" id="copy" name="copy" placeholder="한줄카피를 입력해주세요." maxlength=50 required value="${dto.copy}">
		  	</div>
		  	
			<div class="form-group">
		    	<label for="bookintro">도서 소개</label>
		    	<textarea class="form-control" id="bookintro" name="intro" placeholder="도서소개를 입력해주세요." rows="10" maxlength=1500 required>${dto.intro}</textarea>
		  	</div>
