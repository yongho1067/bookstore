...
<body>
	...
	<section class="contentsection">
		...
		<table class="table tblbookcount">
			...
			<tbody>
				<tr>
					<td><a href="/bookjuck/admin/book/booklist.do"><span class="label label-success">${wholeCnt}</span></a></td>
					<td><a href="/bookjuck/admin/book/booklist.do?seqLCategory=1"><span class="label label-success">${inCnt}</span></a></td>
					<td><a href="/bookjuck/admin/book/booklist.do?seqLCategory=2"><span class="label label-success">${exCnt}</span></a></td>
