...
<body>
	...
	<section class="contentsection">
		...
		<form method="POST" action="/bookjuck/admin/book/bookeditok.do" enctype="multipart/form-data" id="formEdit">
			...
			<div class="form-group">
		  	...
		  	<div class="form-group">
		    	...
		    	<input type="number" class="form-control" id="amount" name="amount" min="0" max="100" value="${dto.amount}" required>
		  	</div>
		  	
		  	<div class="form-group">
		    	<label for="page">페이지 수</label>
		    	<input type="number" class="form-control" id="page" name="page" min="0" value="${dto.page}" required>
		  	</div>
