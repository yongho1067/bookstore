...
<body>
	...
	%>
		<div class="bestSellerList">
			...
			<span class="intro" style="font-weight: bold; position:absolute; left:200px; top:30px;">북적북적의 신간도서를
					소개합니다.</span>
				<br>
				<form id="searchform" method="GET" action="/bookjuck/member/book/newbook.do" style="position:absolute; left:200px;">
					<div id="choicedate">
						<!-- 기간 선택 -->
