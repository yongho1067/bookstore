...
<head>
<meta charset="UTF-8">
<title>약관 동의 및 이메일 인증</title>
<%@include file="/WEB-INF/views/member/inc/asset.jsp"%>
<link rel="stylesheet" href="/bookjuck/css/login.css">
<link rel="stylesheet" href="/bookjuck/css/global.css">
<link rel="stylesheet" href="/bookjuck/css/tos.css">
<style type="text/css">
		...
		<form action="http://localhost:8090/bookjuck/member/register.do" method="GET" id="tosForm">
			...
			<table class="tostbl" id="tostbl1">
				...
				<tr>
					...
					<td>
						<a href="#tosView1" data-toggle="modal">[약관보기]</a>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<a href="#tosView2" data-toggle="modal">[약관보기 ]</a>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<a href="#tosView3" data-toggle="modal">[약관보기]</a>
					</td>
				</tr>
			</table>
			<!-- 첫번째 테이블 끝-->
			...
			<!-- 두번째 테이블 시작 -->		
			 <table class="tostbl table" id="tostbl2">
				<tr>
					<th>이름:</th>
					<td>
...
제26조 (예치금) 
예치금이란 "몰" 이용 중 환불사유가 발생하기 전까지 이용자 소유의 
금액을 임시로 보관하고 있는 것입니다. 이는 다음 번 구매 시 현금처럼 사용하실 수 있으며 회원 본인의 요청에 따라 예치금의 전부 또는 일부를 회원의 계좌로 환급 받으실 수 있습니다. 단, 회원 탈퇴 시에는 적립금과 동일하게 소멸되며	타 회원의 ID로 양도될 수 없습니다.

제27조 (YP e-money)

① 회원은 기프티콘을 통해 전환한 YP e-money를 사용하고 잔액을 환불 받을 수 있습니다. 
YP e-money 총 금액의 100분의 60(1만원 이하 금액은 100분의 80) 이상을 사용하고 환불을 요구하는 경우, "몰"은 사용 후 남은 잔액 전액을 반환합니다.

② YP e-money를 구매한 날로부터 5년이 경과하면 상법상의 상사채권소멸시효가 완성되어 고객은 "몰"에게 물품 등의 제공, 환불 및 잔액반환을 요청할 수 없습니다.
